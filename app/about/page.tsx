    ...
    <main className="min-h-screen bg-[#0b0120] text-white selection:bg-purple-500/30">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0b0120]/80 backdrop-blur-xl border-b border-white/5 py-6 px-6 md:px-12">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link href="/" className="px-6 py-2 bg-white/5 border border-white/10 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-white hover:text-[#0b0120] transition-all">
            Join Waitlist
          </Link>
        </div>
      </nav>
      ...
      {/* Values */}
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-[#0b0120]">
