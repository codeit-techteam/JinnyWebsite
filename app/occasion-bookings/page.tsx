      ...
      <section className="pt-32 pb-20 px-6 md:px-12 lg:px-24 bg-[#0b0120] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
          <div className="space-y-8">
            ...
            <p className="body-text-on-dark text-xl max-w-xl">Hosting a party? Moving in? Just had a celebration? We handle the cleanup so you can focus on the memories.</p>
          </div>
